...
<div class="admin-form">
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-12">
        <!-- Widget starts -->
            <div class="logo"><a href="<?php echo site_url();?>" class="navbar-brand"> <span class="bold">Job</span> Provider</a></div>
            <div class="widget">
              <!-- Widget head -->
              ...
              <div class="widget-content">
                <div class="padd">
					...
					if($this->session->userdata('account_status') == TRUE)
					{
						echo '<div class="alert alert-success"> '.$this->session->userdata('account_creation_message').' </div>';
					}
					?>
                  <!-- Login form -->
                  <?php 
                ...
                <div class="widget-foot">
                  ...
                  Don't have an account? <a href="<?php echo base_url();?>provider-sign-up" class="reset_password">Sign up</a>
