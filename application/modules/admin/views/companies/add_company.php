                    ...
                    <div class="row">
                    	<div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" name="company_contact_person_phone2" placeholder="Contact Person Phone 2" value="<?php echo set_value('company_contact_person_phone2');?>">
                                </div>
                            </div>
                             <!-- Activate checkbox -->
                            <div class="form-group">
                    	...
                    	<div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" name="company_contact_person_email2" placeholder="Contact Person email 2" value="<?php echo set_value('company_contact_person_email2');?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                	<textarea name="company_description" class="form-control" rows="5" placeholder="Insurance Company Description"><?php echo set_value('company_description');?></textarea>
                                </div>
                            </div>
