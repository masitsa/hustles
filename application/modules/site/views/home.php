                ...
                <div class="col-sm-8 page-content">
                    ...
                    <div class="find-job-tabs responsive-tabs">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="index.html#find-job-tabs-map">Map</a></li>
                            <li><a href="index.html#find-job-tabs-industry">Industry</a></li>
                            <li><a href="index.html#find-job-tabs-role">Type</a></li>
                            <li><a href="index.html#find-job-tabs-country">Country</a></li>
                        </ul>
                            ...
                            <ul class="slides">
                                <li>
                                    <div class="image">
                                        ...
                                        <a href="index.html#" class="btn btn-default fa fa-search"></a>
                                        <a href="index.html#" class="btn btn-default fa fa-link"></a>
                                    </div>

                                    <div class="content">
                                        <h6>Front-End Developer at Envato</h6>
                                        <span class="location">Sydney, Australia</span>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolorum, hic corrupti nobis consequuntur nam praesentium dolorem quo accusamus laborum ab. <a href="index.html#" class="read-more">Read More</a></p>
                                    </div>
                                </li>
                    ...
                    <div class="our-partners-section white-container">
                        <ul class="clearfix">
                            <li>
                                <div class="css-table">
                                    <div class="css-table-cell">
                                        <a href="index.html#"><img src="img/content/logo-1.png" alt=""></a>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="css-table">
                                    <div class="css-table-cell">
                                        <a href="index.html#"><img src="img/content/logo-2.png" alt=""></a>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="css-table">
                                    <div class="css-table-cell">
                                        <a href="index.html#"><img src="img/content/logo-3.png" alt=""></a>
                                    </div>
                                </div>
                            </li>
                    ...
                    <div class="pricing-tables tables-3">
                        <div class="pricing-tables-column">
                            <div class="white-container">
                                ...
                                <a href="index.html#" class="btn btn-default">Choose</a>
                            </div>
                        </div>
